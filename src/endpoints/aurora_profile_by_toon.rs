...
use crate::models::{ScrProfile, ScrMmGameLoading, ScrMmToonInfo, ScrToonInfo};
...
impl crate::client::ApiClient {
    ...
    pub async fn get_aurora_profile_by_toon_scr_profile(
        ...
        let endpoint = AuroraProfileEndpoint::new(toon, gateway, AuroraProfileFieldMask::ScrProfile);
    ...
    pub async fn get_aurora_profile_by_toon_mm_game_loading(
        ...
        let endpoint = AuroraProfileEndpoint::new(toon, gateway, AuroraProfileFieldMask::ScrMmGameLoading);
        let json = self.request(&endpoint, &()).await?;
    ...
    pub async fn get_aurora_profile_by_toon_mm_toon_info(
        ...
        let endpoint = AuroraProfileEndpoint::new(toon, gateway, AuroraProfileFieldMask::ScrMmToonInfo);
        let json = self.request(&endpoint, &()).await?;
    ...
    pub async fn get_aurora_profile_by_toon_toon_info(
        ...
        let endpoint = AuroraProfileEndpoint::new(toon, gateway, AuroraProfileFieldMask::ScrToonInfo);
        let json = self.request(&endpoint, &()).await?;
