...
impl ApiClient {
    ...
    pub async fn request<E>(&self, endpoint: &E, params: &E::Request) -> Result<E::Response, ApiError>
    where
        E: Endpoint,
        E::Request: Serialize,
        E::Response: DeserializeOwned,
    {
        ...
        serde_json::from_str(&text)
            .map_err(|e| ApiError::DeserializationError(
                format!("Failed to deserialize: {}. Response starts with: {}", 
                    e, 
